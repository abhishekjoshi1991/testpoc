...
class TrainModel():
    def __init__(self):
        self.daily_training_hours = float(os.getenv('DAILY_TRAINING_HOURS', '4'))  # Default to 4 hours if not specified
        self.checkpoint_dir = os.path.join(project_path, 'checkpoints')
